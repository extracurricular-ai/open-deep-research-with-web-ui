...
- **Installation Docker en une commande, zéro config pour démarrer** — `docker run -p 5080:5080 ghcr.io/extracurricular-ai/open-deep-research-with-web-ui:latest` et une UI web fonctionnelle est en ligne. Recherche DuckDuckGo intégrée ; une seule clé API modèle suffit pour commencer.
